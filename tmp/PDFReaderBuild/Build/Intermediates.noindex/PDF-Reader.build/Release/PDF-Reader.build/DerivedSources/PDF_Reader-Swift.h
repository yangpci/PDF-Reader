...
#ifndef PDF_READER_SWIFT_H
#define PDF_READER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PDF_Reader",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10PDF_Reader24EpubRuntimeSchemeHandler")
@interface EpubRuntimeSchemeHandler : NSObject <WKURLSchemeHandler>
